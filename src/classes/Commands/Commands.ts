...
export default class Commands {
    ...
    async processMessage(steamID: SteamID, message: string): Promise<void> {
        ...
        if (message.startsWith('sell_') || message.startsWith('buy_')) {
            message = message
                .replace('Spec_Ks', 'Specialized Killstreak')
                .replace('Prof_Ks', 'Professional Killstreak')
				.replace('Fest_', 'Festivized ')
				.replace('Ks_', 'Killstreak ')
				.replace('Bruisers_Bandanna', "Bruiser's Bandanna")
